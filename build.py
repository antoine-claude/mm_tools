...
IGNORE_PATTERNS = ('*.pyc', 'tmp*', '*__pycache__*', '.git', '.vscode', '.gitignore', '.gitattributes', 'build.py', 'mm_tools_updater')


# Add root folder to path
if destination_path[-1] in ['/', '\\']:
    destination_path += "mm_tools-" + version_number
else:
    destination_path += "/mm_tools-" + version_number
